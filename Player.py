...
Button(root, image=play_button, bg="#0f1a2b", bd=0, activebackground="#0f1a2b", command=play_song).place(x=100, y=400)

stop_button = PhotoImage(file="stop.png")
Button(root, image=stop_button, bg="#0f1a2b", bd=0, activebackground="#0f1a2b", command=mixer.music.stop).place(x=30,
                                                                                                                y=500)

resume_button = PhotoImage(file="resume.png")
Button(root, image=resume_button, bg="#0f1a2b", bd=0, activebackground="#0f1a2b", command=mixer.music.unpause).place(
    x=115, y=500)

pause_button = PhotoImage(file="pause.png")
Button(root, image=pause_button, bg="#0f1a2b", bd=0, activebackground="#0f1a2b", command=mixer.music.pause).place(x=200,
                                                                                                                  y=500)
...
playlist.pack(side=LEFT, fill=BOTH, expand=1)
